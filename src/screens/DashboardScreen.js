...
import { rf, isTablet, listenForOrientationChange } from '../utils/responsive';
                                                ...
                                                <View style={styles.quickActions}>
                                                        {[
                                                                ...
                                                                >
                                                                        ...
                                                                        >
                                                                                <Icon name={action.icon} size={theme.iconography.xxs} color={action.color} />
                                                                        </View>
...
const styles = StyleSheet.create({
        ...
        quickActionIcon: {
                width: theme.iconography.xl,
                height: theme.iconography.xl,
                borderRadius: rf(26),
                alignItems: 'center',
